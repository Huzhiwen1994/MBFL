...
public class GetCsv {
	...
	public List<String> getCsv(){
		...
		File csv = new File("D:\\MBFL\\sed\\sed_results\\v3_1\\1\\10%.csv");  // 
	...
	public void translate(List<String> list,Instances instances,double percent){
		try {
		File file1 = new File("D:\\MBFL\\sed\\sed_results\\v3_1\\1\\translate_10%vector.arff");  //存放数组数据的文件 
	    FileWriter out1;
	...
	public static void main(String[] args) throws IOException {
		...
		list=getscv.getCsv();
		File file=new File("D:\\MBFL\\sed\\sed_results\\v3_1\\1\\translate.arff");
