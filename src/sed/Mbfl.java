...
public class Mbfl {
	...
	public static void main(String[] args) throws IOException {
		...
		int cover_length;
		int cover[][]=new int [361][9681];
		File file1=new File("D:\\MBFL\\sed\\sed_results\\v3_1\\1\\res_cov_Matrix.in");
		mb.getData(cover,file1);
		System.out.println( cover[1][1]);
		
		int vector[][]=new int [361][2];
		File file2=new File("D:\\MBFL\\sed\\sed_results\\v3_1\\1\\res_vector.in");
		mb.getData(vector,file2);
		System.out.println( vector[1][0]);
		
		int mutant_compare[][]=new int [26740][361];
		File file3=new File("D:\\MBFL\\sed\\sed_results\\v3_1\\1\\res_original_version.in");
	...
	public void cal_Sup(int [][]cover,int [][]vector,int [][]mutant_compare){
	    ...
	    File supFile = new File("D:\\MBFL\\sed\\sed_results\\v3_1\\1\\Sup_Op2_All_change.txt");  //存放数组数据的文件  
		File file1 = new File("D:\\MBFL\\sed\\sed_results\\v3_1\\1\\Sup_Op2_change.txt");  //存放数组数据的文件 
